...
public class ExcelWriter {
    ...
    static {
        ...
        employees.add(new Employee("Benz Nantawat", "Nantawat@example.com",
                dateOfBirth.getTime(), 1200000.0));

        dateOfBirth.set(1965, 10, 15);
        employees.add(new Employee("Arm Arm", "Arm@example.com",
                dateOfBirth.getTime(), 1500000.0));

        dateOfBirth.set(1987, 4, 18);
        employees.add(new Employee("P'Dit P'Dit", "Dit@example.com",
